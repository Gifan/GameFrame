...
declare namespace wx {
    namespace types {
        ...
        interface navigateToMiniProgramParam {
            /**
             * 要打开的小程序 appId
             */
            appId: string,
    ...
    function onShow(cb: (res: { scene: number, query: any, shareTicket: string }) => void): void;
    function offShow(cb: (res: { scene: number, query: any, shareTicket: string }) => void): void;
     ...
     */
    function openCustomerServiceConversation(param: types.CustomParam): void;

    // --小游戏跳转
    function navigateToMiniProgram(param: types.navigateToMiniProgramParam): void;
