...
export class Notifier {
    ...
    public static addListener(msgId : number, callback : Function, context: any, prior = PriorMiddle) : void {
        this._listener.Register(msgId, callback, context, prior);
    }
    ...
    public static delListener(msgId : number, callback : Function, context: any) : void {
        this._listener.Unregister(msgId, callback, context);
    }
    ...
    /// </summary>
    /// <param name="msgId"></param>        
    public static send(msgId : number, t1? : any , t2? : any, t3? : any, t4? : any) : void {
        this._listener.Send(msgId, t1, t2, t3, t4);
    }

    public static isExist(msgId : number) : boolean {
        return this._listener.IsExist(msgId);
    }

    public static setListenNameHandler(handler : (id : number) => string) {
        this._listener.setIdToNameHandler(handler);
    }
    ...
    public static setCall(msgId : number,  callback : Function, context: any) : boolean {
        return this._caller.Register(msgId, callback, context);
    }
    ...
    public static delCall(msgId : number,  callback : Function, context: any) : boolean {
        return this._caller.Unregister(msgId, callback, context);
    }
    ...
    public static call<T1, T2, T3, TResult>(msgId : number, t1? : any, t2? : any, t3? : any,  t4? : any) : any {
        return this._caller.Call(msgId, t1, t2, t3, t4);
    }

    public static setCallNameHandler(handler : (id : number) => string) {
        this._caller.setIdToNameHandler(handler);
    }
}
